...
def main():
    ...
    savings_maturity = int(input('What is the lenght of months for your Savings'))
    ...
    #print("The balance is: $", format(updated_savings_balance.get_balance(), ',.2f'))
    #print("APR Interest Rate is: ", format(interest_earned.get_interest(), ',.2f'),"%")
    #print("Length of Savings is: ", (savings_maturity.get_months(), ',.2f'))
    ...
    #print("The balance is: $", format(updated_cd_balance.get_balance(), ',.2f'))
    #print("APR Interest Rate is:", format(interest_earned.get_interest(), ',.2f'),'%')
    #print(f"Length of CD is: {cd_maturity.get_months()} months.")
